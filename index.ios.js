...
var Start = React.createClass({
  ...
  render() {
    return <NavigatorIOS initialRoute={{component: Pokegame, title: "Pokegame", passProps: {token: this.state.token}}} style={{flex: 1}} navigationBarHidden={true} />
  }
});
...
var Pokegame = React.createClass({
  ...
  componentDidMount() {
    console.log("[TOKEN BABY]", this.state.token);
  ...
  render() {
    ...
    return (
      <View style={{flex: 1, borderTopWidth: 1, borderColor: '#d3d3d3', alignItems: 'center'}}>
        ...
        }} style={{height: 30, width: 70, borderWidth: 1, borderLeftWidth: 0, justifyContent: 'center', alignItems: 'center'}}>
  ...
  return (
      ...
      <View
        style={{
          ...
          <Image source={{uri: 'http://localhost:3000/emojis/'+this.props.rowData.toLowerCase()+'.png'}} style={{width: 40*widthUnit, height: 40*height/736, marginTop: 1}} />
